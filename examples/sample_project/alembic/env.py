"""
Alembic env.py - This demonstrates how to use alembic-autoscan!

Notice how we don't need to manually import User, Post, or any other models.
The library automatically discovers and imports them for us.
"""
...
# ============================================================
# THIS IS THE MAGIC! 🎉
# Instead of manually importing all your models, just call:
