...
class TestCLI:
    ...
    def test_scan_command_basic(self, mock_get_root, mock_scanner_class):
    ...
    @patch("alembic_autoscan.cli.ModelScanner")
    def test_scan_command_custom_path(self, mock_scanner_class):
    ...
    @patch("alembic_autoscan.cli.ModelScanner")
    def test_scan_command_no_models_found(self, mock_scanner_class):
